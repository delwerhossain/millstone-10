          ...
          <form className="mt-6">
            ...
            <div className="mt-6">
              ...
              <button
                ...
                className="w-full px-4 py-2 tracking-wide text-white transition-colors duration-200 transform bg-blue-900 rounded-md hover:bg-blue-600 focus:outline-none focus:bg-blue-600 font-semibold flex gap-4 text-center justify-center"
              >
                <img
                  className="w-5"
